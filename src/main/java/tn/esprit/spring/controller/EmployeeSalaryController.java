...
public class EmployeeSalaryController {
	...
	@ResponseBody		
	public EmployeeSalary fichedepaie(@PathVariable("id_user") Long idUser) {
		return salaryService.ficheDePaie(idUser).get(0);
	}
	@PutMapping("/affecterSalaryToUser/{salary_id}/{id_user}")
	@ResponseBody
	public void affecterSalaryToUser(@PathVariable("salary_id") int idp,@PathVariable("id_user") Long idUser) {
		salaryService.affecterSalaryToUser(idp, idUser);
	}
