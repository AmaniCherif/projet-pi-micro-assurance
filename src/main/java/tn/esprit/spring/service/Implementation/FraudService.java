...
//    IFraudRepo Fraud ;
//
//	public void verifFraud(int idUser){
//		Fraud f = new Fraud();
...
//		f.setValide("Verifer ce contrat !");
//		f.setNiveau(0);
//		int user = c.getContractRequest().getUser().getIdUser();	
...
//		f.setValide("Verifer ce contrat !");
//		f.setNiveau(0);
//		int user = s.getSinistreReport().getContract().getContractRequest().getUser().getIdUser();
